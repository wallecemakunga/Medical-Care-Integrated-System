...
$query = "
    ...
    FROM doctors d
    INNER JOIN clinics c ON d.clinic_id = c.clinic_id
    " or die('Error');
...
?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="delete.php?pat_id=<?php echo $n?>&&pat_name=<?php echo $e?>" onclick="return confirm('Are you sure you want to delete Doctor');" class="badge badge-danger"><i class="mdi mdi-eye"></i> Delete</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
